...
CREATE TABLE Individual_Unit (
                                 ...
                                 CONSTRAINT fk_individual_unit_arrival FOREIGN KEY (arrival_id) REFERENCES Product_Arrival(arrival_id) ON DELETE CASCADE
);

CREATE OR REPLACE TRIGGER trg_individual_unit_update
BEFORE UPDATE ON Individual_Unit
                  FOR EACH ROW
BEGIN
...
CREATE TABLE Inventory (
                           ...
                           CONSTRAINT fk_individual_sku_arrival FOREIGN KEY (arrival_id) REFERENCES Product_Arrival(arrival_id) ON DELETE CASCADE
);
